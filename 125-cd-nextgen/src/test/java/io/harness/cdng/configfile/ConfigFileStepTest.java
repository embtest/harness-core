...
@OwnedBy(CDP)
public class ConfigFileStepTest extends CDNGTestBase {
  private static final String IDENTIFIER = "identifier";
  private static final String HOST_DESTINATION = "host/destination";
  private static final String FILE_PATH = "file/path";
  private static final String FILE_REFERENCE = "account.fileReference";
  private static final String HOST_DESTINATION_OVERRIDE = "host/destination/override";
  ...
  @InjectMocks private ConfigFileStep configFileStep;

  @Test
  @Owner(developers = IVAN)
  @Category(UnitTests.class)
  public void testGetStepParametersClass() {
    assertThat(configFileStep.getStepParametersClass()).isEqualTo(ConfigFileStepParameters.class);
  }
  ...
  public void testExecuteSyncHarnessStore() {
    ...
    StepResponse response =
        configFileStep.executeSync(ambiance, stepParameters, getStepInputPackage(), getPassThroughData());
  ...
  public void testExecuteSyncHarnessStoreWithStageOverride() {
    ...
    StepResponse response = configFileStep.executeSync(ambiance, stepParameters, stepInputPackage, passThroughData);
