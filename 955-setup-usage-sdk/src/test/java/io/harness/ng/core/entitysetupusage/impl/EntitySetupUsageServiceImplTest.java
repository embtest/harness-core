...
public class EntitySetupUsageServiceImplTest extends EntitySetupUsageTestBase {
  ...
  public void verifyListAllWhenReferreByTypeIsEmpty() {
    Page<EntitySetupUsageDTO> result = entitySetupUsageService.listAllEntityUsagePerEntityScope(0, 10, accountIdentifier, referredByEntityName, EntityType.FILES, null, null);
